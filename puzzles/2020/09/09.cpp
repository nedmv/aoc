// Puzzle is available at https://adventofcode.com/2020/day/9
#include "../2020.hpp"
using namespace std;

std::string y2020::solve_09a(const std::vector<std::string> &input) {
...
std::string y2020::solve_09b(const std::vector<std::string> &input) {
